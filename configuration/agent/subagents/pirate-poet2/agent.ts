...
const agentApiKey = process.env.AGENT_PIRATE_POET2_API_KEY!;
const mcpServerId = process.env.AGENT_PIRATE_POET2_MCP_SERVER_ID!;
...
export default chatKitEndpoint({
  client,
  webhookSigningKey: process.env.AGENT_PIRATE_POET2_WEBHOOK_SIGNING_KEY!,
