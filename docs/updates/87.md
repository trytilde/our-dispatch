...
Forks must deploy Tilde API PR 160 (or a later API release containing `GET /api/v1/team/{team_id}/chatkit/workspace/search`) before applying this update. No state, secret, or environment migration is required; redeploy the OpenBot control service and clients after updating.
