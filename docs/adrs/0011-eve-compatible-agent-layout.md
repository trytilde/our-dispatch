...
- 2026-09-01T11:38:00+02:00: Recorded Tilde's invariant system human-handoff mapping: Computer retains it on the MCP resource but excludes it from the exact-name model catalogue, while reconciliation removes every non-system mapping.
