...
- 2026-08-27T14:20:00+02:00: Migrated Mission Control REST calls to regular ChatKit activity, agent, session, message, search, and turn routes; initial load now consumes the single `GET /chatkit/activity` envelope while the Mission Control WebSocket contract remains unchanged.
