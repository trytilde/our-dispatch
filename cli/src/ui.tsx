...
const commands = [
  ...
  ["delete-agent ID --yes --json", "Delete an agent and its managed resources"],
  ...
  ["eval --json", "Measure production agent, Computer, and routine behavior"],
...
const menuItems = [
  ...
  { command: "delete-agent", description: "Delete an agent" },
  ...
  { command: "eval", description: "Measure production behavior" },
